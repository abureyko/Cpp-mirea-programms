// (28) Создать файл, данными которого являются: номер зачетной книжки, ФИО студента, список из 5 предметов с оценками в сессии. Отсортировать файл по результат второго экзамена.
// для тебя
